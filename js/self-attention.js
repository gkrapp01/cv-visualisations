    ...
    },
    {
      ...
      render: function () {
        ...
        return [
          ...
          '      <span style="color:#8b8fa8;margin:0 0.3rem">·</span>',
          '      <span class="sa-k">[ K₁, K₂, K₃, K₄ ]ᵀ</span>',
          '      <span style="color:#8b8fa8;margin:0 0.3rem">→</span>',
          '      <span class="sa-score">Scores for patch 1</span>',
          '    </div>',
          '    <div class="sa-score-bars">' + barsHtml + '</div>',
          '    <div style="text-align:center;margin-top:0.8rem;font-size:0.85rem;color:#8b8fa8">',
    ...
    },
    {
      ...
      render: function () {
        ...
        return [
          ...
          '      </div>',
          '    </div>',
          '    <div style="text-align:center;margin-top:0.5rem;font-size:0.82rem;color:#8b8fa8;font-family:\'JetBrains Mono\',monospace">',
